...
export default function EditPopup({ isOpen, closePopup }: EditPopupProps) {
    ...
    <div className={clsx("bg-foreground/35 fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center z-10 transition-all", {
      ...
      <div className={clsx(" transition-all bg-white w-full max-w-[500px] rounded-xl flex flex-col p-6 gap-3 relative", {
        ...
        <div className="flex flex-col gap-1 items-center">
          <p className="text-primary font-bold text-3xl">แก้ไขข้อมูล</p>
        </div>
        ...
        <button className="cursor-pointer bg-primary rounded-xl py-3 text-white hover:scale-95 transition-transform mt-8">บันทึกการแก้ไข</button>
      </div>
    </div>
  </>
}